...
// TCPRequestChannel* create_new_channel (TCPRequestChannel* chan, int b,string ipAddr,string portNo) {
...
//     nchan = new TCPRequestChannel(ipAddr,portNo);
...
int main (int argc, char *argv[]) {
    ...
    TCPRequestChannel* chan = new TCPRequestChannel(ipAddr,portNo);
    ...
    for (int i = 0; i < w; i++) {
        wchans[i] = new TCPRequestChannel(ipAddr,portNo);
    }
